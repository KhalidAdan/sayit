//! Signed self-update. Windows keeps Tauri's installer path. Linux downloads
//! the signed raw binary, probes it, and atomically swaps it in place; the old
//! inode keeps this process running until the next normal launch.
...
#[cfg(target_os = "linux")]
pub use linux::{check_and_install, mark_healthy, preflight};
